...
/// <summary>
/// A Minion communicating with other minions and their users
/// Communication is done through a SignalR Hub and the BusyLight API.
/// </summary>
public class MinionBusyLightOnlineHub
{
    ...
    public async Task Execute()
    {
        ...
        BusyLightHubPlugin busyLightHubPlugin = new BusyLightHubPlugin("Jose", "Bill");
        KernelPlugin BusyLightplugin = KernelPluginFactory.CreateFromObject(busyLightHubPlugin);
